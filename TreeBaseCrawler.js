...
exports.TreeBaseCrawler = exports.PoliteCrawler = void 0;
const lodash = require("lodash");
const { TreeBase } = require("jtree/products/treeBase.node.js");
class TreeBaseCrawler {
    constructor(treebase) {
        this.base = treebase;
    }
}
exports.TreeBaseCrawler = TreeBaseCrawler;
class PoliteCrawler {
    constructor() {
        this.running = 0;
