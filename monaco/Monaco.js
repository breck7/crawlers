...
class MonacoImporter extends MeasurementsCrawler.MeasurementsCrawler {
  extractComments(match) {
    ...
    try {
      if (
        (_a = conf.comments) === null || _a === void 0 ? void 0 : _a.lineComment
      ) {
      ...
      if (
        (_b = conf.comments) === null || _b === void 0
          ? void 0
          : _b.blockComment
      ) {
