...
class CompilerExplorerImporter extends TreeBaseCrawler_1.TreeBaseCrawler {
    init() {
        prepLangFile();
    }
    get languages() {
    ...
    writeDataCommand() {
        this.matched.forEach(pair => new TreeBaseFileWithCompilerExplorer(pair.file, pair.lang).writeInfo());
    }
