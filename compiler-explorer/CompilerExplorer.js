...
class CompilerExplorerImporter extends TrueBaseCrawler_1.TrueBaseCrawler {
    init() {
        prepLangFile();
    }
    get languages() {
    ...
    writeDataCommand() {
        this.matched.forEach(pair => new TrueBaseFileWithCompilerExplorer(pair.file, pair.lang).writeInfo());
    }
