...
class DBLPFile {
    ...
    write() {
        ...
        file
            .getNode("dblp")
            .appendLineAndChildren("publications", new TreeNode(table.slice(0, 10)).toDelimited("|"));
...
class DBLPImporter extends TrueBaseCrawler_1.TrueBaseCrawler {
...
exports.DBLPImporter = DBLPImporter;
